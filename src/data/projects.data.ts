...
export function getProjects(t: TFunc): ProjectItem[] {
  return [
    {
      id: "redlinkGPT",
    ...
    },
    {
      ...
      gallery: ["./assets/projects/redlinkat-whitepaper/redlink-good-search-ux-innen.jpg","./assets/projects/redlinkat-whitepaper/redlink-llm.jpg"],
